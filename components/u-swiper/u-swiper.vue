<template>
	<view class="u-swiper-wrap" :style="{
				...
				<view class="u-list-image-wrap" @tap.stop.prevent="listClick(index)"
					...
					<view class="container">
						<view class="left-image">
							...
							<image class="left-img" mode="scaleToFill" :src="item.Bimg "></image>
						</view>
						<view class="right-images">
							<view class="right-images-item" v-for="(it, id) in item.image" :key="id" style="">
								<!-- 高度不变，宽度自动变化，保持原图宽高比不变 -->
								<image class="top-image"  mode="heightFix" :src="it.img "></image>
							</view>
						</view>
		...
		<view class="u-swiper-indicator" :style="{
				...
				bottom: indicatorPos == 'bottomLeft' || indicatorPos == 'bottomCenter' || indicatorPos == 'bottomRight' ? '35rpx' : 'auto',
